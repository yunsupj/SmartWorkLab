  ...
  return (
    <div className="bg-slate-900 p-4 rounded-lg border border-slate-800 shadow-sm">
      <div className="flex justify-between items-end mb-2">
        <h3 className="text-sm font-semibold text-slate-300">Transparency Score</h3>
        <span className="text-xs text-slate-500">{sourceCount} Sources Analyzed</span>
      </div>
      ...
      <p className="mt-2 text-xs text-slate-500">
        Metric based on analyzed GitHub repos, Reddit threads, and user reports.
      </p>
    </div>
  );
}
